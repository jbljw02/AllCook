            ...
            await transporter.sendMail({
                ...
                html: `
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size: 32px; font-weight:bold; text-align: left;">All Cook 문의 메시지</td>
                            </tr>
                            <tr style="height: 20px;">
                            </tr>
                            <tr>
                                <td style="font-size: 14px; color: #1E1E23;">All Cook 사용자 ${data.name}님에게 온 메시지입니다.</td>
                            </tr>
                            <tr>
                                <td style="font-size: 14px; color: #1E1E23;">사용자의 아이디는 jbljw02입니다.</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: left; font-size: 14px"> • ${data.mail}</td>
                            </tr>
                            <tr style="height: 30px">
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: left; font-size: 14px"> • ${data.tel}</td>
                            </tr>
                            <tr style="height: 30px">
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: left; font-size: 14px"> • ${data.content}</td>
                            </tr>
                        </tbody>
                    </table>
                `,
