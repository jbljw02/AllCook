                ...
                <div ref={contentsRef} className='contents-container'>
                    ...
                    <div className='explain-container'>
                        ...
                        <table className='explain-table'>
                            <thead>
                                <tr>
                                    {/* td 태그는 중앙정렬 되어있어 border 길이가 너무 길고 조절이 불가능하기 때문에, 
                                    span 태그를 추가하여 컨트롤 */}
                                    <td>
                                        <span>01</span>
                                    </td>
