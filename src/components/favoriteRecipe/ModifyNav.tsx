...
import { FavoriteRecipe, resetIsCheckedRecipe, setFavoriteRecipe, setIsCheckedRecipe, setIsFavRecipeDelete, setSelectedFolder } from "@/redux/features/favoriteRecipeSlice";
...
export default function ModifyNav() {
    ...
    const startDeleteWork = () => {
        dispatch(setIsFavRecipeDelete(!isFavRecipeDelete))
    }
        ...
        <>
            <div className="modify-container">
                <label
                    ...
                    style={{ visibility: !isFavRecipeDelete ? 'hidden' : undefined }}>
                    <input
                ...
                </label>
                {
                    !isFavRecipeDelete ?
                        ...
                        <div className="is-delete-div">
                            <div className="toggle-div cursor-pointer">
                                <div
                                    className="modify-text no-drag"
