        ...
        <>
            <div className={`${category === 'header' ?
                ...
                <svg className="svg" xmlns="http://www.w3.org/2000/svg" width="17px" height="17px" viewBox="0 0 25 25" fill="none">
                        <path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" stroke="#292D32" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M20.5899 22C20.5899 18.13 16.7399 15 11.9999 15C7.25991 15 3.40991 18.13 3.40991 22" stroke="#292D32" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                    <div>회원 정보</div>
                </div>
                <div
                    ...
                    <svg className="svg" xmlns="http://www.w3.org/2000/svg" width="17px" height="17px" viewBox="0 0 23 23" fill="none">
                        <path d="M15 16.5V19C15 20.1046 14.1046 21 13 21H6C4.89543 21 4 20.1046 4 19V5C4 3.89543 4.89543 3 6 3H13C14.1046 3 15 3.89543 15 5V8.0625M11 12H21M21 12L18.5 9.5M21 12L18.5 14.5" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                    <div>로그아웃</div>
                </div>
            </div>
