...
export default function Header({ className, backgroundColor, color, borderColor, svgFill }: { className: string, backgroundColor: string, color: string, borderColor: string, svgFill: string }) {

    return (
        <>
            <header className={`${className} header`} style={{ backgroundColor: backgroundColor, color: color, borderColor: borderColor }}>
                <div>
                    <svg className='img-logo' xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 1103.000000 1280.000000" preserveAspectRatio="xMidYMid meet">
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" stroke={svgFill} stroke-width="350">
