                                    ...
                                    Array.from({ length: 5 }, (_, index) => (
                                        <div className="star">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="19px" height="19px" fill="none" viewBox="0 0 12 12">
                                                <path fill="#e0e3e6" stroke="#e0e3e6" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" d="m6 1 1.545 3.13 3.456.505L8.5 7.07l.59 3.44L6 8.885 2.91 10.51l.59-3.44L1 4.635l3.454-.505L6 1z"></path>
                                            </svg>
                                        </div>
                                    ))
                                }
                    ...
                    <div className="review-comments-div">
                        <div className="comment-contents-header">
                            ...
                            <div className="star-div">
                                ...
                                <div className="review-score">4</div>
                            </div>
                        </div>
